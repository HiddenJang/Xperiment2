...
class Ui_MainWindow_client(object):
    def setupUi(self, MainWindow_client):
        ...
        self.pushButton_startAutoBet.setGeometry(QtCore.QRect(59, 190, 181, 25))
        ...
        self.pushButton_cleanRegistry.setGeometry(QtCore.QRect(58, 254, 181, 23))
        ...
        self.label_betSizeSecond.setGeometry(QtCore.QRect(144, 111, 131, 16))
        ...
        self.spinBox_betSizeSecond.setGeometry(QtCore.QRect(164, 130, 70, 20))
        ...
        self.pushButton_closeBrowsers.setGeometry(QtCore.QRect(88, 224, 151, 21))
        ...
        self.label_betSize.setGeometry(QtCore.QRect(81, 90, 101, 16))
        ...
        self.spinBox_betSizeFirst.setGeometry(QtCore.QRect(30, 130, 70, 20))
        ...
        self.label_resultExtractionTimeout = QtWidgets.QLabel(self.frame_autoBetSettings)
        self.label_resultExtractionTimeout.setGeometry(QtCore.QRect(10, 301, 231, 16))
        self.label_resultExtractionTimeout.setObjectName("label_resultExtractionTimeout")
        self.spinBox_resultExtractionTimeout = QtWidgets.QSpinBox(self.frame_autoBetSettings)
        self.spinBox_resultExtractionTimeout.setGeometry(QtCore.QRect(30, 320, 70, 20))
    ...
    def retranslateUi(self, MainWindow_client):
        ...
        self.label_resultExtractionTimeout.setText(_translate("MainWindow_client", "Интервал проверки результатов"))
