...
class Ui_MainWindow_client(object):
    def setupUi(self, MainWindow_client):
        ...
        self.pushButton_openBrowser = QtWidgets.QPushButton(self.frame)
        self.pushButton_openBrowser.setGeometry(QtCore.QRect(350, 272, 141, 25))
        self.pushButton_openBrowser.setObjectName("pushButton_openBrowser")
        self.layoutWidget_2.raise_()
        self.frame_2.raise_()
        self.layoutWidget.raise_()
        self.pushButton_openBrowser.raise_()
    ...
    def retranslateUi(self, MainWindow_client):
        ...
        self.pushButton_openBrowser.setText(_translate("MainWindow_client", "Открыть браузер"))
