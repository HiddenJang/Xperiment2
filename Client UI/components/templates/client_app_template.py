...
class Ui_MainWindow_client(object):
    def setupUi(self, MainWindow_client):
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(31, 299, 273, 58))
        ...
        self.listWidget_diagnostics.setGeometry(QtCore.QRect(5, 390, 555, 161))
        ...
        self.frame_autoBetSettings.setGeometry(QtCore.QRect(564, 0, 296, 551))
        ...
        self.pushButton_startAutoBet.setGeometry(QtCore.QRect(65, 506, 181, 25))
        ...
        self.label_betSizeFirst.setGeometry(QtCore.QRect(10, 111, 131, 16))
        self.label_betSizeFirst.setObjectName("label_betSizeFirst")
        self.pushButton_enableBetSet = QtWidgets.QPushButton(self.frame_autoBetSettings)
        self.pushButton_enableBetSet.setGeometry(QtCore.QRect(74, 156, 91, 23))
        self.pushButton_enableBetSet.setObjectName("pushButton_enableBetSet")
        self.label_betSizeSecond = QtWidgets.QLabel(self.frame_autoBetSettings)
        self.label_betSizeSecond.setGeometry(QtCore.QRect(144, 113, 131, 16))
        ...
        self.spinBox_betSizeSecond.setGeometry(QtCore.QRect(164, 133, 42, 20))
        ...
        self.pushButton_closeBrowsers.setGeometry(QtCore.QRect(90, 470, 151, 21))
        ...
        self.label_betSize.setGeometry(QtCore.QRect(67, 90, 101, 16))
        self.label_betSize.setObjectName("label_betSize")
        self.checkBox_betImitation = QtWidgets.QCheckBox(self.frame_autoBetSettings)
        self.checkBox_betImitation.setGeometry(QtCore.QRect(10, 51, 281, 16))
        ...
        self.spinBox_betSizeFirst.setGeometry(QtCore.QRect(30, 131, 42, 20))
    ...
    def retranslateUi(self, MainWindow_client):
        ...
        self.pushButton_enableBetSet.setText(_translate("MainWindow_client", "Применить"))
