...
class Ui_desktopClient(object):
    def setupUi(self, desktopClient):
        ...
        self.widget.setGeometry(QtCore.QRect(31, 21, 335, 212))
        self.widget.setObjectName("widget")
        self.gridLayout = QtWidgets.QGridLayout(self.widget)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.label_sportType = QtWidgets.QLabel(self.widget)
        ...
        self.label_marketType = QtWidgets.QLabel(self.widget)
        self.label_marketType.setObjectName("label_marketType")
        self.gridLayout.addWidget(self.label_marketType, 6, 1, 1, 1)
        self.comboBox_secondBkmkr = QtWidgets.QComboBox(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.comboBox_sportType = QtWidgets.QComboBox(self.widget)
        ...
        self.comboBox_gameStatus = QtWidgets.QComboBox(self.widget)
        ...
        self.label_firstBkmkr = QtWidgets.QLabel(self.widget)
        ...
        self.label_gameStatus = QtWidgets.QLabel(self.widget)
        ...
        self.widget1.setGeometry(QtCore.QRect(31, 258, 261, 57))
        ...
        self.pushButton_stopScan = QtWidgets.QPushButton(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton_startScan = QtWidgets.QPushButton(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, desktopClient):
        ...
        self.comboBox_sportType.setItemText(0, _translate("desktopClient", "Футбол"))
        self.comboBox_sportType.setItemText(1, _translate("desktopClient", "Баскетбол"))
        self.comboBox_sportType.setItemText(2, _translate("desktopClient", "Хоккей"))
        self.comboBox_gameStatus.setItemText(0, _translate("desktopClient", "Prematch"))
        self.comboBox_gameStatus.setItemText(1, _translate("desktopClient", "Inplay (live)"))
        self.label_firstBkmkr.setText(_translate("desktopClient", "Первый букмекер"))
        self.comboBox.setItemText(0, _translate("desktopClient", "Тотал"))
        self.comboBox.setItemText(1, _translate("desktopClient", "Победитель"))
        self.comboBox.setItemText(2, _translate("desktopClient", "Фора"))
